...
@_spi(Internal) public struct FetchAssetCollection<Result: PHAssetCollection>: DynamicProperty {
  @ObservedObject
...
@_spi(Internal) public extension FetchAssetCollection {
  ...
  init(filter: NSPredicate? = nil,
       sort: [(KeyPath<PHAssetCollection, some Any>, ascending: Bool)]) {
