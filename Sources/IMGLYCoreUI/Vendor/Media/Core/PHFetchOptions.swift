...
@_spi(Internal) public extension PHFetchOptions {
  ...
  func includeAssetSourceTypes(_ sourceTypes: PHAssetSourceType) -> Self {
    includeAssetSourceTypes = sourceTypes
    return self
  }
  ...
  func sort(by keyPath: KeyPath<some Any, some Any>, ascending: Bool = true) -> Self {
