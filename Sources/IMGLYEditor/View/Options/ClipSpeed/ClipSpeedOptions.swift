      ...
      VStack(spacing: 16) {
        VStack(spacing: 0) {
          ClipSpeedRow(
            ...
            placeholder: "--",
            suffix: String(localized: .imgly.localized("ly_img_editor_sheet_clip_speed_speed_suffix")),
          ...
          ClipSpeedRow(
            ...
            placeholder: "--",
            suffix: String(localized: .imgly.localized("ly_img_editor_sheet_clip_speed_duration_suffix")),
