...
enum TextProperty: Labelable, IdentifiableByHash, CaseIterable {
  case inactive, bold, italic, underline, strikethrough
  ...
  var localizationValue: String.LocalizationValue {
    ...
    case .underline: "ly_img_editor_sheet_format_text_button_underline"
    case .strikethrough: "ly_img_editor_sheet_format_text_button_strikethrough"
    }
  }
